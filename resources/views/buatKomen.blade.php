 ...
 <div style="padding-top: 40px;" class="buatKomen">
    <div style="background-color: #ffffff; padding-top: 20px;" class="d-flex row">
        ...
        <div class="form-group" style="padding-top: 20px;">
            <textarea name="textarea" style="border: 0px" rows="5" cols="65">Apa Komentar Anda ?</textarea>
            <br>
        </div>
        <div class="row">
            <div style="padding-top: 5px; height: 100px; align: bottom;" class="row flex-nowrap">
                <div class="col-3">
                ...
                <div class="col-5">
                    ...
                    <button type="submit" style="font-family: Poppins, sans-serif;background-color: #982727; border: none !important; box-shadow: none !important;" class="btn btn-primary">Kirim</button>
                </div>
            </div>
        </div>
    </div>
