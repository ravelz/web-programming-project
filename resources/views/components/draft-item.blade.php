    ...
    <div class="d-flex flex-row">
        ...
        <div class="col-md-8">
            <div class="card-body" style="height: auto">
                ...
                <div id = "follow-tit" style="max-height:400px;"><p class="card-text" style="padding-left: 8px;color:black;font-size:34px; font-weight:400;">{{ $draft->judul }}</p></div>
                <div id = "follow-desc"style="max-height:400px">
                <p class="card-text" style="padding-left: 8px;color:background: #374A59;
                    ;font-size:20px; font-weight:400; padding-top:24px">{{ $draft->deskripsi }}</p>
                </div>                
                <div class="d-flex flex-row p-2">
                    <div class="ms-auto" style="margin-top:8px">
                        <a href = "{{route('edit', ['id'=>$draft->id_draft, 'judul'=>$draft->judul])}}"style="text-decoration : none; padding-top: 8px; padding-right:32px;color:#5E5D2D;font-size:20px; font-weight:600;">Baca Lebih 
