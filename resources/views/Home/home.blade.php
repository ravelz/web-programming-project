                                    ...
                                    <div class="card" style="height:auto; border-radius: 0px;">
                                        ...
                                        <div class="first-layer">
                                            <div class="kategori-waktu">
                                                <p id="kategori-small" class="kategori text-wrap">TEMPAT WISATA</p>
                                                <p id ="waktu-small" class = "waktu text-wrap">17 Jam yang lalu</p>
                                            </div>
                                        </div>
                            
                                        <h1 style="color: black" id = "judul-small" class="judul text-wrap">Judul Artikel</h1>
                                        <p style = "color: black;" id = "deskripsi-small" class="deskripsi text-wrap">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, quidem..</p>
                                        ...
                                        <div class="last-layer">
                                            ...
                                            <a href="" style="text-decoration: none" id = "name-small" class="nama-penulis text-wrap">Steven Matthew</a>
