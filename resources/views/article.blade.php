        ...
        <div class="row d-flex flex-row">
            <div class="d-flex flex-row justify-content-between">
                <div class="d-flex" style="margin-bottom:20px">
                    <a href="{{ route('profile', ['username' => $read->username]) }}" class="d-flex flex-row justify-content-between text-decoration-none text-black">
                        <img class="img-fluid rounded-circle" style="width: 50px; height: 50px;border-radius: 100%;float: right;" src="{{ asset('storage/'.$read->profile_picture) }}" alt="">
                    </a>
                ...
                <div class="d-flex ">
                    @if (Auth::user()->isFollowing($read->id_user))
                    <a href="{{ route('unfollow', ['id' => $read->id_user]) }}">
                    ...
                    @else
                        <a href="{{ route('follow', ['id' => $read->id_user]) }}">
                            <svg style="margin-right: 10px;" width="50" height="50" viewBox="0 0 67 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="33.5" cy="33.5" r="32" stroke="#B5B5B5" stroke-width="3"/>
