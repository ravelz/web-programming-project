    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" style="font-weight: 700; color:#982727">Bagikan Artikel</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p style="margin-bottom: 10px">Pilih media sosial untuk menyebarkan artikel ini</p>
                <p> </p>
                <p> </p>
                <div class="d-flex flex-col justify-content-center mt-6">
                    {!! $share !!}
                </div>
            </div>
        </div>
